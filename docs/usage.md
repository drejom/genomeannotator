...
```bash
nextflow run nf-core/genomeannotator --input ./samplesheet.csv --outdir ./results --genome GRCh37 -profile docker
```
...
```bash
nextflow run nf-core/genomeannotator -profile docker -params-file params.yaml
```
